...
export class Migration1765013446483 implements MigrationInterface {
    name = 'Migration1765013446483'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`patient-records\` DROP COLUMN \`created_time\``);
        await queryRunner.query(`ALTER TABLE \`patient-records\` ADD \`created_time\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP`);
