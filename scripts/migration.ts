...
export class Migration1764903355015 implements MigrationInterface {
    name = 'Migration1764903355015'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`patient-records\` (\`identifier\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`hash\` varchar(255) NOT NULL, \`blockId\` varchar(255) NULL, \`patient_identifier\` int NOT NULL, \`hospital_identifier\` int NOT NULL, PRIMARY KEY (\`identifier\`)) ENGINE=InnoDB`);
